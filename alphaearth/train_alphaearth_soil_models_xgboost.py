#!/usr/bin/env python3
"""Train soil property XGBoost regressors from local AlphaEarth embedding samples."""
...
OUT_DIR = ROOT / "alphaearth" / "outputs_xgboost"
...
def plot_observed_vs_predicted(predictions: pd.DataFrame, metrics: pd.DataFrame) -> None:
    ...
    fig.suptitle("AlphaEarth 2018 embeddings: XGBoost cross-validated regression", fontsize=10)
